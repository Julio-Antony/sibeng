                    ...
                    <div class="transaction">
                        <table class="transaction-tabel">
                            ...
                            foreach ($sales_detail as $key => $value) { ?>
                                <tr>
                                    <td colspan="2" width="165"><?= $value->product_name ?></td>
                                    <td class="text-center"> <?= $value->qty ?></td>
                                    <td class="text-right" width="70"><?= indo_currency($value->price) ?></td>
                                    <td class="text-right" width="60">
                                        <?= indo_currency($value->price * $value->qty) ?>
                                    </td>
                                </tr>
                            ...
                            <tr>
                                <td colspan="2"></td>
                                <td colspan="2" style="text-align: right; padding:5px 0;"><b>Grand Total :<b></td>
                            ...
                            <tr>
                                <td colspan="2"></td>
                                <td colspan="2" style="border-top:1px dashed; text-align: right; padding-top:5px;"><b>Bayar :<b></td>
                            ...
                            <tr class="mt-2">
                                <td colspan="2"></td>
                                <td colspan="2" style="border-top:1px ; text-align: right; padding-top:5px;"><b>Kembalian :<b></td>
