...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">Stock in data</h1>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
</div>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="float-right">
                            <a href="<?= site_url('stock/stock_in_add') ?>" class="btn btn-primary btn-flat btn-sm">
                                ...
                                foreach ($row as $key => $data) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="<?= site_url('stock/stock_in_delete/' . $data->stock_id . '/' . $data->item_id) ?>" onclick="return confirm('yakin hapus data?')" class="btn btn-danger btn-flat btn-xs">
